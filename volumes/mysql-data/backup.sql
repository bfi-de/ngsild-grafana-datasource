...
('fiware-grafana-123', 'FIWARE Grafana', 'FIWARE Grafana is a Grafana instance with the NGSI-LD datasource enabled', 'fiware-grafana-clientsecret', 'http://fiware-grafana:3000', 'http://localhost:3000/login', 'http://localhost:3000/logout', 'default', 'client_credentials', '', NULL, NULL, NULL, 'bearer', NULL);
...
('fiware-grafana-123','43f3acf36cc1c9c329462b85665cc4db74fa9b2e','d02e82482fe7f267','fiware-grafana-123');
...
(5,NULL,'fiware-grafana-123','provider',NULL,'aaaaaaaa-good-0000-0000-000000000000');
